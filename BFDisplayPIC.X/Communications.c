...
void readRemoteAlarm( struct buffer *send_buffer );
void setRemoteAlarm( struct buffer *send_buffer );



void readRemotePassword( struct buffer *send_buffer );
void setRemotePassword( struct buffer *send_buffer );

void readRemoteEmergency( struct buffer *send_buffer );
void setRemoteEmergency( struct buffer *send_buffer );

void readRemoteResetTime( struct buffer *send_buffer );
void setRemoteResetTime( struct buffer *send_buffer );

void readRemoteRelay( struct buffer *send_buffer );
void setRemoteRelay( struct buffer *send_buffer );

void readRemoteStat( struct buffer *send_buffer );

void readRemoteCBver( struct buffer *send_buffer );

void readRemotePowerFailTimes( struct buffer *send_buffer );
